...
namespace ShaderEffectsLibrary
{
    ...
    /// </summary>
    public class CircularVignette : ShaderEffect
    {
        #region Dependency Properties
        /// <summary>
        /// Gets or sets the FilterColor variable within the shader.
        /// </summary>
        public static readonly DependencyProperty FilterColorProperty = DependencyProperty.Register("VignetteFilterColor", typeof(Color), typeof(CircularVignette), new UIPropertyMetadata(Colors.White, PixelShaderConstantCallback(0)));

        /// <summary>
        /// Gets or sets the Radii variable within the shader.
        /// </summary>
        //public static readonly DependencyProperty RadiiProperty = DependencyProperty.Register("Radii", typeof(Size), typeof(CircularVignette), new UIPropertyMetadata(new Size(0.2, 0.2), PixelShaderConstantCallback(0)));

        /// <summary>
        /// Gets or sets the center variable within the shader.
        /// </summary>
        //public static readonly DependencyProperty CenterProperty = DependencyProperty.Register("Center", typeof(Point), typeof(CircularVignette), new UIPropertyMetadata(new Point(0.25, 0.25), PixelShaderConstantCallback(1)));

        /// <summary>
        /// Gets or sets the amount variable within the shader.
        /// </summary>
        // public static readonly DependencyProperty ShrinkFactorProperty = DependencyProperty.Register("ShrinkFactor", typeof(double), typeof(CircularVignette), new UIPropertyMetadata(0.5, PixelShaderConstantCallback(2)));

        /// <summary>
        /// Gets or sets the input used in the shader.
        /// </summary>
        public static readonly DependencyProperty InputProperty = ShaderEffect.RegisterPixelShaderSamplerProperty("VignetteInput", typeof(CircularVignette), 0);
        ...
        /// </summary>
        static CircularVignette()
        {
            pixelShader = new PixelShader();
            pixelShader.UriSource = new Uri("/Effects;component/CircularVignette.ps", UriKind.Relative);
        }
        ...
        /*     private class MagnifyGeneralTransform : GeneralTransform
         {
               ...
               /// The effect instance.
               /// </summary>
               private readonly CircularVignette effect;
               ...
               public MagnifyGeneralTransform(CircularVignette fx)
               {
                   this.effect = fx;
               }
